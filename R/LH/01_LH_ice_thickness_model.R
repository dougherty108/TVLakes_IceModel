###### Ice Thickness Model — Lake Hoare (LH) ########
...
# through time at Lake Hoare, Taylor Valley, Antarctica. Ice thickness is
...
# lake_constants(), and plot_ice_model(). All LH-specific choices live in
# LAKE_CONFIGS$LH and were already applied when `inputs` was built in
# 00_LH_data_preparation.R.
...
# 00_LH_data_preparation.R to change how many years the model runs for.
