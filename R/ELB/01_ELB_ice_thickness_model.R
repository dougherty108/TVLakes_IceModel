###### Ice Thickness Model — East Lake Bonney (ELB) ########
...
# through time at East Lake Bonney, Taylor Valley, Antarctica. Ice thickness is
...
#
# Data is provided primarily by the McMurdo Dry Valleys Long Term Ecological
# Research project, with albedo surface estimates coming from derived surface
...
# 00_ELB_data_preparation.R to change how many years the model runs for.
